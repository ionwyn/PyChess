...
"""
This part of code does not belong to me.  Chessnut is the Copyright owner
and their project is under MIT license.
...
class Game(object):
    ...
    def get_moves(self, player=None, idx_list=list(range(64))):
        """
    ...
    def _all_moves(self, player=None, idx_list=list(range(64))):
        """
